    ...
    <div>
           ...
           <div style="margin-bottom: 20px;">
            ...
            @cancel="showErcode = fasle" >
              <div class="flex justify-center align-center">
                <img  src="@/assets/image/share-ercode.png" style="width:120px;"  />
              </div>
            </a-modal>
            ...
            <a-table :dataSource="list" :columns="columns" :pagination="false" bordered size="middle">
                ...
                <div class="handler" slot="operation" slot-scope="text,record,index">
                    ...
                    <a-button type="primary" @click="copyLink(index)" size="small" style="margin-right:10px">复制链接</a-button>
        ...
        <div v-if="showAdd">
            <a-drawer :title="updateInfo ? '修改链接' : '新增链接'" :placement="'right'" :closable="false" width="40%" :visible="showAdd"
                @close="showAdd = false">
                <AddShare :type="0" stubline :info="updateInfo" @success="refreshList" />
            </a-drawer>
        </div>
    </div>
</template>
...
export default {
    ...
    methods: {
        ...
        copyLink:function(index){
            const url = `m.mk-ytx.cn/?id=${this.list[index].id}`;
